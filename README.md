...
[![Release](https://img.shields.io/github/v/release/?style=flat-square&color=#7c3aed)](https://github.com/Shesher007/MYTH/releases/download/v1.1.6)
[![License](https://img.shields.io/badge/license-MIT-blue?style=flat-square)](https://github.com/Shesher007/MYTH/blob/main/LICENSE)
...
- [**Installer (.msi)**](https://github.com/Shesher007/MYTH/releases/download/v1.1.6/MYTH_1.1.6_x64_en-US.msi)
- [**Portable (.exe)**](https://github.com/Shesher007/MYTH/releases/download/v1.1.6/MYTH_1.1.6_x64-setup.exe)
...
**Debian / Ubuntu / Kali**
```bash
wget https://github.com/Shesher007/MYTH/releases/download/v1.1.6/myth_1.1.6_amd64.deb
sudo dpkg -i myth_1.1.6_amd64.deb
```

**Fedora / RHEL / CentOS**
```bash
wget https://github.com/Shesher007/MYTH/releases/download/v1.1.6/myth-1.1.6-1.x86_64.rpm
sudo rpm -i myth-1.1.6-1.x86_64.rpm
```

**Universal AppImage**
```bash
wget https://github.com/Shesher007/MYTH/releases/download/v1.1.6/MYTH_1.1.6_amd64.AppImage
...
- [**Universal (.dmg)**](https://github.com/Shesher007/MYTH/releases/download/v1.1.6/MYTH_1.1.6_universal.dmg)
